...
namespace DaftAppleGames.SubnauticaPets.Extensions
{
    ...
    internal static class GameObjectExtensions
    {
        ...
        {
            LogUtils.LogDebug(LogArea.Prefabs, $"Layer index of {targetGameObject} is currently {targetGameObject.layer}");
            LogUtils.LogDebug(LogArea.Prefabs, $"Setting Layer of {targetGameObject} to {layerIndex}");
