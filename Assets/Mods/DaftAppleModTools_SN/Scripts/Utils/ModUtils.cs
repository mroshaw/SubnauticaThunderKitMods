...
namespace DaftAppleGames.ModTools
{
    ...
    internal static class ModUtils
    {
        ...
        /// </summary>
        public static void DumpTagNamesFromScene(ModLog modLog)
        {
            ...
            {
                modLog.LogDebug($"Tag (in use): {tag}");
            }
        }
        ...
        /// </summary>
        public static void DumpTagNames(ModLog modLog)
        {
            ...
            {
               modLog.LogDebug("InternalEditorUtility not found.");
                return;
            }
            ...
            if (tagsProp == null)
            {
                modLog.LogDebug("Tags property not found.");
                return;
            }
        ...
        /// </summary>
        public static void DumpLayerNames(ModLog modLog)
        {
            // List all layers
            for (int i = 0; i < 32; i++)
            {
                ...
                {
                    modLog.LogDebug($"Layer {i}: {name}");
                }
            }
        }

        public static void DumpLayerCollisionMatrixAsExcel(ModLog modLog)
        {
        ...
        /// </summary>
        public static void DumpLayerCollisionMatrix(ModLog modLog)
        {
            for (int i = 0; i < 32; i++)
            {
                ...
                for (int j = i; j < 32; j++) // symmetric, so start from i
                {
                    ...
                    modLog.LogDebug($"[{i}:{layerNameI}] vs [{j}:{layerNameJ}] => " +
