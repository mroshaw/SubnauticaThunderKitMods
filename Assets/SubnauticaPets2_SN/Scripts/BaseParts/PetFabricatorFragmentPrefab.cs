    ...
    internal static class PetFabricatorFragmentPrefab
    {
        ...
        public static void Register()
        {
            ...
            SpawnLocation[] spawnLocations =
            {
                    ...
                    new SpawnLocation(new Vector3(12.01f, -28.85f, -243.06f), new Vector3(11.23f, 0.61f, 1.94f)), // warp 11.23 0.61 1.94
                    new SpawnLocation(new Vector3(76.28f, -30.01f, -88.79f), new Vector3(290.52f, 172.81f, 186.37f)), // warp 290.52 172.81 186.37
                    new SpawnLocation(new Vector3(82.50f, -40.76f, 117.07f), new Vector3(3.60f, 357.73f, 330.99f)), // warp 3.60 357.73 330.99
