...
namespace DaftAppleGames.SubnauticaPets.Utils
{
    ...
    internal static class CustomAssetBundleUtils
    {
        ...
        {
            LogUtils.LogDebug(LogArea.Utilities, $"ModUtils: Looking for GameObject named {objectName} in Asset Bundle.");
            ...
            LogUtils.LogDebug(LogArea.Utilities, $"ModUtils: Found GameObject named {objectName} in Asset Bundle.");
            return obj;
        }
        ...
        public static GameObject GetPrefabInstanceFromAssetBundle(string objectName, bool activeState)
        {
            ...
            if (obj == null)
            {
                LogUtils.LogError(LogArea.Utilities, $"ModUtils: Couldn't find Prefab named {objectName} in Asset Bundle.");
                return null;
            }
            LogUtils.LogDebug(LogArea.Utilities, $"ModUtils: Found Prefab named {objectName} in Asset Bundle.");
